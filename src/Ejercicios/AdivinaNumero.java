...
public class AdivinaNumero {
	public static void main(String[] args) {
		...
		/*
		 * Genera un número aleatorio entre 0 y 99, lo asigna a 'random', y declara las
		 * variables 'num' e 'intentos' para almacenar el número ingresado por el
		 * usuario y el número de intentos.
		 */

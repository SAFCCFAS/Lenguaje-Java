                        ...
                        switch (origen) {
                            case 1 -> {
                                while (true) {
                                    ...
                                    switch (destino) {
                                        case 1 -> medidaDestino = switch (unidad) {
                                            case 1 -> "Metro";
                                            case 2 -> "Centímetro";
                                            default -> "Milímetro";
                                        };
                                        case 2 -> medidaDestino = switch (unidad) {
                                            case 1 -> "Kilómetro";
                                            case 2 -> "Centímetro";
                                            default -> "Milímetro";
                                        };
                                        case 3 -> medidaDestino = switch (unidad) {
                                            case 1 -> "Kilómetro";
                                            case 2 -> "Metro";
                                            default -> "Milímetro";
                                        };
                                        default -> medidaDestino = switch (unidad) {
                                            case 1 -> "Kilómetro";
                                            case 2 -> "Metro";
                                            default -> "Centímetro";
                                        };
                                    ...
                                    System.out.printf("La %s en %s (%s) es: %.2f%n", categoria, medidaDestino, simbMed, conversion);
                                    return;
                                }
                            }
                            case 2 -> {

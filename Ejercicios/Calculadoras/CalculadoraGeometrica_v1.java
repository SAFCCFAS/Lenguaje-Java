	...
	public static void main(String[] args) {
		...
		while (true) { // repetir el menú hasta que se ingrese la opción correcta
			...
			case 1 -> {
				while (true) {
					System.out.println(
							"Favor elija la figura a calcular área:\n1. Cuadrado.\n2. Rectángulo.\n3. Triángulo.\n4. Círculo.\n5. Trapecio.");
					...
					return; // en este punto teniendo en cuenta el nivel de conocimiento es preferible usar
			...
			case 2 -> {
				while (true) {
					System.out.println(
							"Favor elija la figura a calcular perímetro:\n1. Cuadrado.\n2. Rectángulo.\n3. Triángulo.\n4. Círculo.\n5. Trapecio.");
					System.out.println("6. Rombo.\n7. Polígono regular.\n8. Octágono.\n9. Regresa menú anterior");
					eleccion = sc.nextLine().trim();
					if (eleccion.trim().isEmpty() || !eleccion.matches("[1-9]")) {
						System.err.println("Error: Opción o ingreso no válido, favor use las opciones dentro del rango.");

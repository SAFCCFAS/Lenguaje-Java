...
public class ConversionDeTemperaturaArray {
	...
	public static void main(String[] args) {
		...
		String eleccion, unidadDestino;
		int opc, destino, origenIndex, destinoIndex;
		double temperatura, factor, desplazamiento, resultado;
		...
		origenIndex = opc - 1;
		destinoIndex = destino - 1;
		factor = conversiones[origenIndex * 2 + destinoIndex][0]; // Factor de conversión
		desplazamiento = conversiones[origenIndex * 2 + destinoIndex][1]; // Desplazamiento

		// Realizar la conversión y mostrar el resultado
		resultado = temperatura * factor + desplazamiento;
